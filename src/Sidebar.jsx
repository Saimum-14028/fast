...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`z-10 md:fixed overflow-x-hidden bg-base-200 md:w-64 w-40 space-y-6 px-2 py-4 absolute inset-y-0 left-0 transform ${
        isActive && '-translate-x-full'}  md:translate-x-0  transition duration-200 ease-in-out`}>
          ...
          <div className='flex flex-col justify-between flex-1'>
            ...
            <nav>
                <MenuItem label='My Profile' address='/dashboard/profile'></MenuItem>
            </nav>
